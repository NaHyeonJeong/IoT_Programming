...
typedef struct Node_ {
	void *key; // domain or ip
	void *value1; // ip or domain
	int value2; // hit count
	char color;
	struct Node_ *left;
	struct Node_ *right;
} Node;
...
Node *insertR(Node *node, void *k, void *v, int hit, int(*compare)(const void *key1, const void *key2));
void insert(RBT *tree, void *k, void *v, int hit);
